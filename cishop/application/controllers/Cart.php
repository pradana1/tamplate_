...
class Cart extends MY_Controller {
    ...
    public function update($id)
    {
        ...
        // Select data di table cart
        $data['input']      = (object) $this->input->post(null, true);
        $this->cart->table  = 'product';

        // Select data di table product dengan id product dari hasil select table cart tadi
        // idproduct bukan dari table product, tapi dari table cart dari select sebelumnya
